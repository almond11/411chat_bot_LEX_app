...
if(!defined('SKIP_ROUTE')) {
	...
	switch ($route) {
		...
		case 'recipe':	include _include(APP_PATH.'route/recipe.php'); 	break;
		case 'searchadv':	include _include(APP_PATH.'route/searchadv.php'); 	break;
		case 'reclist':	include _include(APP_PATH.'route/reclist.php'); 	break;
		case 'recipeadd':	include _include(APP_PATH.'route/recipeadd.php'); 	break;
		case 'recipes_recent':	include _include(APP_PATH.'route/recipes_recent.php'); 	break;
		
		case 'tools':	include _include(APP_PATH.'route/tools.php'); 	break;
